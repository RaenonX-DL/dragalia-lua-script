...
m.LocationRandomRoom = Location(434, 1329)

m.LocationIdSelect = Location(1020, 1606)

m.PathRoomQuestText = PathParent .. "rmquest.png"
m.RegionRoomQuestText = Region(963, 2426, 207, 69)
m.LocationQuestStart = Location(1117, 2394)
m.LocationQuestStartDialog = Location(1036, 1815)
